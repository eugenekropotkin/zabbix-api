...
abstract class ZabbixApiAbstract
{
    ...
    public function requestna($method, $params=NULL, $resultArrayKey='', $auth=TRUE)
    {
...
//            'auth'    => ($auth ? $this->auth : ''),
    ...
    final public function userLoginna($params=array(), $arrayKeyProperty='')
    {
        $params = $this->getRequestParamsArray($params);
        $this->auth = $this->requestna('user.login', $params, $arrayKeyProperty, FALSE);
        return $this->auth;
    }
